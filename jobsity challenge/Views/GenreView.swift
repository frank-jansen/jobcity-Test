...
//  jobsity challenge
//
//  Created by Frank Jansen on 5/12/22.
//
    ...
    var body: some View {
        ZStack{
            RoundedRectangle(cornerRadius: 20)
                ...
                .frame(minWidth: 100, maxWidth: 150, maxHeight: 80)
            Text(genres)
                .padding()
        }
    }
